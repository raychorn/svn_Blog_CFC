...
<cfmodule template="../../tags/podlayout.cfm" title="RSS">
	...
	<cfif ( (session.persistData.loggedin) AND (Request.commonCode.isUserPremium()) )><a href="#rssShortURL#" target="_blank">#application.resourceBundle.getResource("shortmode")#</a><cfelse><a href="" title="#anchorTitle#" onclick="rssFeedsRequiresPremiumBlock(); return false;">#application.resourceBundle.getResource("shortmode")#</a></cfif> / <cfif ( (session.persistData.loggedin) AND (Request.commonCode.isUserPremium()) )><a href="#rssFullURL#" target="_blank">#application.resourceBundle.getResource("fullmode")#</a><cfelse><a href="" title="#anchorTitle#" onclick="rssFeedsRequiresPremiumBlock(); return false;">#application.resourceBundle.getResource("fullmode")#</a></cfif><br>
	</p>
	</center>
	</cfoutput>
