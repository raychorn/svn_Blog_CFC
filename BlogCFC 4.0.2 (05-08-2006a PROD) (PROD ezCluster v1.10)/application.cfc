<cfcomponent>
	...
	<cffunction name="onRequestStart" access="public">
		...
		//	Request.bool_isDebugMode = ( (CGI.REMOTE_ADDR eq '127.0.0.1') OR (Find('192.168.', CGI.REMOTE_ADDR) gt 0) );
			...
			Request.pagesThatMustHaveReferrer = 'agooglead.cfm,cfcontent_img.cfm,cfcontent_js.cfm,addcomment.cfm,category_editor.cfm,contactUs.cfm,editor.cfm,eula.cfm,forgotPassword.cfm,login.cfm,print.cfm,register.cfm,stats.cfm,trackback.cfm,trackbacks.cfm,unsubscribe.cfm';
