...
<cfoutput>
	<cfscript>
		queryStr = CGI.QUERY_STRING;
		xPos = Find('?', CGI.HTTP_REFERER);
	...
	<iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="Auto" src="_index.cfm?#queryStr#"></iframe>
</cfoutput>
