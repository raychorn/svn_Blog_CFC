...
<head>
	...
	<cfif 0>
		<cfset _jsCode = jsMinifier(obfuscateJScode(_jsCode))>
	<cfelse>
...
<cfif 0>
	<cfscript>
		writeOutput((NOT IsDefined("application.crossBrowserLibraryJSCode")) OR (Len(application.crossBrowserLibraryJSCode) eq 0));
	</cfscript>

	<textarea class="textClass" cols="120" readonly rows="20">
	<cfoutput>#application.crossBrowserLibraryJSCode#</cfoutput>
	</textarea>

	<cfdump var="#URL#" label="B. URL Scope" expand="No">
	<cfdump var="#CGI#" label="B. CGI Scope" expand="No">
</cfif>
