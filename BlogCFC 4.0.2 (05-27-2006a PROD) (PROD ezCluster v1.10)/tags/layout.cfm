...
<head>
	...
	<cfsavecontent variable="_jscode"><cfoutput>#Request.commonCode.readAndObfuscateJSCode('js/decontextmenu.js')##Request.commonCode.readAndObfuscateJSCode('js/CrossBrowserLibrary.js')##Request.commonCode.readAndObfuscateJSCode('js/displaySysMessages.js')##Request.commonCode.readAndObfuscateJSCode('js/onscroll.js')##Request.commonCode.readAndObfuscateJSCode('js/ArrayPrototypes.js')##Request.commonCode.readAndObfuscateJSCode('js/StringPrototypes.js')##Request.commonCode.readAndObfuscateJSCode('js/getSelection.js')##Request.commonCode.readAndObfuscateJSCode('js/jsObjectExplainer.js')##Request.commonCode.readAndObfuscateJSCode('js/jsEventExplainer.js')##Request.commonCode.readAndObfuscateJSCode('js/jsErrorExplainer.js')##Request.commonCode.readAndObfuscateJSCode('js/GUIObjectCache.js')##Request.commonCode.readAndObfuscateJSCode('js/clientWid$.js')##Request.commonCode.readAndObfuscateJSCode('js/clientHt$.js')##Request.commonCode.readAndObfuscateJSCode('js/support.js')##Request.commonCode.readAndObfuscateJSCode('js/BlogSupportLibrary.js')##Request.commonCode.readAndObfuscateJSCode('js/BlogSupportLibraryAdmin.js')##Request.commonCode.readAndObfuscateJSCode('js/snapins.js')#</cfoutput></cfsavecontent>
