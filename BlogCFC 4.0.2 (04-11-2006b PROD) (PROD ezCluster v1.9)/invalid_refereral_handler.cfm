...
<cfoutput>
	...
	<tr>
		<td colspan="3">
			<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), 'agooglead.cfm', '/')) & "&enableMetaRefresh=30">
			<iframe id="iframe_google_ad" name="iframe_google_ad" frameborder="0" scrolling="No" width="480" height="75" src="#_url#" <cfif isDebugMode()>title="_url = [#_url#]"</cfif>></iframe>
		</td>
	</tr>
	<tr>
