...
<!--- +++ --->
	...
	<cffunction name="registerNoticeMessage" access="public" returntype="string">
		...
		<cfset var _urlValidateLink = Request.commonCode.clusterizeURL('http://rabid.contentopia.net') & '/' & ListFirst(CGI.SCRIPT_NAME, '/') & '/validateUserAccount/#_username_#/' & '?' & _uuid_>
