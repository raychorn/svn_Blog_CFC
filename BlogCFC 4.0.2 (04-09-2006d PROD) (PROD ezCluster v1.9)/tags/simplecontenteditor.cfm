...
<cfif attributes.editmode>
	...
	<a href='' onclick="launchEditor("#jsstringformat(attributes.name)#","#jsstringformat(newwindow)#"); return false;" style="text-decoration: none;">[Edit this Content: #attributes.name#]</a>
	<cfif not structKeyExists(request,cachekey)>
		...
		<form action="#_URL#&#cgi.query_string#" method="post" name="sce" style="display: inline; ">
