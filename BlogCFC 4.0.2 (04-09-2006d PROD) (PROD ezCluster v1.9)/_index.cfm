...
<cfmodule template="tags/layout.cfm">
	...
	<cfelseif url.mode is "cat">
		<cftry>
			...
			<cfcatch>
				<cflocation url="#Request.commonCode.clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#" addToken="false">
			</cfcatch>
		</cftry>
		<cfoutput>
		#application.resourceBundle.getResource("viewingbycategory")# : #cat# / <a href="#Request.commonCode.clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>	
	<cfelseif url.mode is "search">
		<cfoutput>
		#application.resourceBundle.getResource("searchedfor")# : #htmlEditFormat(form.search)# / <a href="#Request.commonCode.clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>
	<cfelseif url.mode is "entry">
		<cfoutput>
		#application.resourceBundle.getResource("viewingbyentry")# / <a href="#Request.commonCode.clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>
	</cfif>
