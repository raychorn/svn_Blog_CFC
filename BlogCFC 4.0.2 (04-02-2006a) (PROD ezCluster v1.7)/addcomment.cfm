	...
	<cfoutput>
		...
		<!--
			function closeCommentsAndRefreshHomePage(id) {
				...
				var url = "http://#CGI.SERVER_NAME##ListDeleteAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), '/')#/index.cfm" + '?uuid=' + parent.uuid();
