...
<cfif (session.persistData.loggedin) AND (NOT CGI.REQUEST_METHOD IS "POST")>
	...
	<cfset _url = Request.commonCode._clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME#' & '/' & ListFirst(CGI.SCRIPT_NAME, '/') & '/original_index.cfm')>
	...
	<tr>
		...
		<input type="reset" value="#application.resourceBundle.getResource("cancel")#" onClick="if (!!closeCommentsAndRefreshHomePage) { closeCommentsAndRefreshHomePage('#_ID#'); }; return false;">
		</td>
	</tr>
	</table>
