...
<cfmodule template="../../tags/podlayout.cfm" title="RSS">
	...
	<a href="http://www.feedvalidator.org/check.cgi?url=http://rayhorn.contentopia.net/blog/rss.cfm%3Fmode%3Dfull" target="_blank"><img src="#application.rooturl#/images/valid-rss.png" height="18" alt="[Valid RSS]" title="Validate my RSS feed" /></a>
	</center>
	</cfoutput>
