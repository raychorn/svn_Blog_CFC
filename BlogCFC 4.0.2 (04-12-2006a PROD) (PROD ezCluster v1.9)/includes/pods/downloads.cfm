...
<cfset _isScopeCache_disabled = (session.persistData.loggedin) AND (Request.commonCode.isUserAdmin())>
<cfmodule template="../../tags/scopecache.cfm" cachename="pod_downloads" scope="db" disabled="#_isScopeCache_disabled#" timeout="#application.timeout#">
