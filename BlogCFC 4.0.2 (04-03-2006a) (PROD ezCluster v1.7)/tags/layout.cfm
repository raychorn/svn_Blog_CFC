...
<head>
	...
	<cfoutput>
	<cfif 0>
	<script language="JavaScript1.2" src="http://#CGI.SERVER_NAME#/blog/includes/cfcontent_js.cfm?jsName=../js/decontextmenu.js" type="text/javascript"></script>
	</cfif>
	<script language="JavaScript1.2" src="http://#CGI.SERVER_NAME#/blog/includes/cfcontent_js.cfm?jsCodeBase=1" type="text/javascript"></script>
	<script language="JavaScript1.2" src="http://#CGI.SERVER_NAME#/blog/includes/cfcontent_js.cfm?jsCodeBase=2" type="text/javascript"></script>
	</cfoutput>
</head>
