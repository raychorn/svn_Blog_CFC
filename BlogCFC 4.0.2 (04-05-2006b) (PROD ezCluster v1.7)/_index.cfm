...
<cfmodule template="tags/layout.cfm">
	...
	<cfoutput query="articles" startrow="#url.startrow#" maxrows="#maxEntries#">
		...
		<cfif application.isColdFusionMX7 AND (session.loggedin)><a href="#application.rooturl#/print.cfm?id=#id#" target="_blank">#application.resourceBundle.getResource("print")#</a><cfelse>#application.resourceBundle.getResource("print")#</cfif> | 
