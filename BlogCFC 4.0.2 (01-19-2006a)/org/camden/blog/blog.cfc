...
<cfcomponent displayname="Blog" hint="BlogCFC by Raymond Camden" output="No">
	...
	<cffunction name="init" access="public" returnType="blog" output="false"
		...
		<!--- Config file --->
		<cfset var cfgFile="#getDirectoryFromPath(GetCurrentTemplatePath())#/blog.ini">
	...
	<cffunction name="addCategory" access="public" returnType="uuid" roles="admin" output="false"
	...
	<cffunction name="addEntry" access="public" returnType="uuid" roles="admin" output="false"
				hint="Adds an entry.">
...
#getProperty("unsubscribeurl")#?email=#email#&token=#token#
	...
	<cffunction name="assignCategory" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="assignCategories" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="deleteEntry" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="makeLink" access="public" returnType="string" output="false"
		...
		<cfif (Request.overrideServerMode)>
			<cfscript>
				a = ListToArray(_url, "/");
				p = ArrayToList(a, "/");
	...
	<cffunction name="removeCategory" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="removeCategories" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="saveCategory" access="public" returnType="void" roles="admin" output="false"
	...
	<cffunction name="saveEntry" access="public" returnType="void" roles="admin" output="false"
				hint="Saves an entry.">
		<cfargument name="id" type="uuid" required="true">
		<cfargument name="title" type="string" required="true">
		<cfargument name="body" type="string" required="true">
