	...
	<cffunction name="onRequestStart" access="public">
		...
		<cfscript>
			...
			if (FindNoCase(Request.const_blogURLMode_APACHE, CGI.SERVER_SOFTWARE) gt 0) {
				if ( (FindNoCase('D:\Apache2\htdocs\', CGI.PATH_TRANSLATED) gt 0) OR (FindNoCase('C:\Inetpub\wwwroot\', CGI.PATH_TRANSLATED) gt 0) ) {
		...
		<cftry>
			...
			<cfcatch type="Any">
				<cfdump var="#cfcatch#" label="Problem with original_Application.cfm" expand="No">
			</cfcatch>
		</cftry>
