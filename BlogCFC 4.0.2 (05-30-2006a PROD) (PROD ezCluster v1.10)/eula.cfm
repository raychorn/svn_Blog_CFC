...
<cfsavecontent variable="eulaContent">
	...
	<div class="body">
		<OL>
			...
			<LI><p align="justify" class="normalBoldBluePrompt">Users may not use Email Addresses from the following sites (HotMail.Com, GMail.Com, googlemail.com or Yahoo.Com) because these are considered to be anonymous email services.  Additional anonynous email services will be blocked as they are identified.</p></LI>
