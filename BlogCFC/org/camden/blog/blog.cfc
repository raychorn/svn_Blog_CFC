...
<cfcomponent displayName="Blog" output="false" hint="BlogCFC by Raymond Camden">
	...
	<cffunction name="addEntry" access="remote" returnType="uuid" roles="admin" output="false"
				hint="Adds an entry.">
...
#getProperty("unsubscribeurl")#?email=#email#&token=#token#
				...
				<cfif instance.mailserver is "">
					<cfmail to="#email#" from="#getProperty("owneremail")#" subject="#getProperty("blogtitle")# / #arguments.title#">#theMessage#</cfmail>
				<cfelse>
	...
	<cffunction name="addTrackBack" returnType="string" access="public" output="false"
		...
		<cfset arguments.title = htmlEditFormat(arguments.title)>
		<cfset arguments.blogName = htmlEditFormat(arguments.blogName)>
		...
		<cfquery name="checkTrackBack" datasource="#instance.dsn#">
			...
			and		postURL = <cfqueryparam value="#left(arguments.url,255)#" cfsqltype="CF_SQL_VARCHAR">
		</cfquery>
		...
		<cfif not checkTrackBack.recordcount>
			<cfquery datasource="#instance.dsn#">
				insert	into tblblogtrackbacks (id, title, posturl, blogname, excerpt, created, entryid, blog)
						...
						<cfqueryparam value="#left(arguments.title,255)#" cfsqltype="CF_SQL_VARCHAR">,
						<cfqueryparam value="#left(arguments.url,255)#" cfsqltype="CF_SQL_VARCHAR">,
						<cfqueryparam value="#left(arguments.blogName,255)#" cfsqltype="CF_SQL_VARCHAR">,
	...
	<cffunction name="getActiveDays" returnType="string" output="false" hint="Returns a list of days with Entries.">
		...
		<cfquery datasource="#instance.dsn#" name="days">
			...
			where 
				...
				and posted <= <cfqueryparam value="#dtEndOfMonth#" cfsqltype="CF_SQL_TIMESTAMP">
				and blog = <cfqueryparam value="#instance.name#" cfsqltype="CF_SQL_VARCHAR" maxlength="50">
	...
	<cffunction name="getCategory" access="remote" returnType="string" output="false">
		<cfargument name="id" type="uuid" required="true">
		<cfset var getC = "">
	...
	<cffunction name="getEntries" access="remote" returnType="query" output="false"
		...
		<cfquery name="getEm" datasource="#instance.dsn#">
			...
			<cfif structKeyExists(arguments.params,"byMonth")>
				and month(posted) = <cfqueryparam value="#arguments.params.byMonth#" cfsqltype="CF_SQL_NUMERIC">
			</cfif>
			
			<cfif structKeyExists(arguments.params,"byYear")>
				and year(posted) = <cfqueryparam value="#arguments.params.byYear#" cfsqltype="CF_SQL_NUMERIC">
			</cfif>
			...
			<cfloop item="address" collection="#emailAddresses#">
				...
				<cfif findNoCase("%unsubscribe%", arguments.message)>
					<cfif address is not instance.ownerEmail>
						<cfset ulink = 
						application.blog.getProperty("unsubscribeURL") & 
	...
	<cffunction name="pingAggregators" access="public" returnType="void" output="false" 
		...
		<cfloop index="aURL" list="#instance.pingurls#">
		...
		<cfoutput>
		   <cfsavecontent variable="pingData">
		      ...
		      <methodCall>
		       ...
		       <params>
		       <param>
		       <value>#instance.blogTitle#</value>
		       </param>
		       <param>
		       <value>#instance.blogURL#</value>
		       </param>
		       </params>
		      </methodCall>
		   </cfsavecontent>
	...
	<cffunction name="pingWeblogs" output="false" returnType="boolean" access="public" 
		...
		<cfsavecontent variable="pingData">
			...
			<methodCall>
				<methodName>weblogUpdates.ping</methodName>
				<params>
					<param><value>#instance.blogTitle#</value></param>
					<param><value>#instance.blogURL#</value></param>
				</params>
			</methodCall>
		</cfsavecontent>
		</cfoutput>
