...
<tr>
	...
	<td><input type="text" name="blog_name" value="#form.blog_name#" maxlength="255"></td>
</tr>
<tr>
	<td>Your Blog Entry Title:</td>
	<td><input type="text" name="title" value="#form.title#" maxlength="255"></td>
</tr>
<tr>
	<td colspan=2>
	Excerpt from your Blog Entry:<br>
	<textarea name="excerpt" cols=50 rows=10>#form.excerpt#</textarea>
	</td>
</tr>
<tr>
	<td>Your Blog Entry URL:</td>
	<td><input type="text" name="url" value="#form.url#" maxlength="255"></td>
</tr>
<tr>
	<td>&nbsp;</td>
