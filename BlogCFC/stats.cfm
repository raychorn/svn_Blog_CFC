...
<cfmodule template="tags/layout.cfm" title="#application.resourceBundle.getResource("stats")#">
	...
	<table border="1" width="100%">
		...
		<tr>
			<td><b><a href="index.cfm?mode=entry&entry=#id#">#title#</a></b></td>
			<td>#commentCount#</td>
		</tr>
		</cfloop>
	</table>
	...
	<table border="1" width="100%">
		<cfloop query="topCommentedCategories">
			...
			<tr>
				<td><b><a href="index.cfm?mode=cat&catid=#categoryid#">#categoryname#</a></b></td>
	...
	<table border="1" width="100%">
		...
		<tr>
			<td><b><a href="#application.rooturl#/index.cfm?mode=search&search=#urlEncodedFormat(searchterm)#">#searchterm#</a></b></td>
			<td>#total#</td>
		</tr>
		</cfloop>
	</table>
