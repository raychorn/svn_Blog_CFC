	...
	<cfmodule template="../../tags/podlayout.cfm" containerClass="rightMenuWide" title="#application.resourceBundle.getResource("archivesbysubject")#">
		...
		<cfloop query="Request.cats">
			<cfif entryCount>
				...
				<cfoutput><NOBR><small>[<cfif ( (session.persistData.loggedin) AND (Request.commonCode.isUserPremium()) )><a href="#_rssURL#" target="_blank">RSS</a><cfelse><a href="" title="#anchorTitle#" onclick="return false;">RSS</a></cfif>]&nbsp;|&nbsp;(#RepeatString('&nbsp;', _paddingCnt - Len(entryCount))##entryCount#)&nbsp;|&nbsp;<a href="#_catURL#">#categoryName#</a></small></NOBR><br></cfoutput>
			</cfif>
		</cfloop>
