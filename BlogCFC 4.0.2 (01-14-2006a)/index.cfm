...
<cfmodule template="tags/layout.cfm">
	...
	<cfoutput query="articles" startrow="#url.startrow#" maxrows="#maxEntries#">
		...
		<div class="byline">
		<cfif allowcomments><a href="javaScript:launchComment('#id#', true)">#application.resourceBundle.getResource("comments")# (<cfif commentCount is "">0<cfelse>#commentCount#</cfif>)</a> | </cfif> 
		<cfif allowTB><a href="javaScript:launchTrackback('#id#', true)">Trackbacks (<cfif trackbackCount is "">0<cfelse>#trackbackCount#</cfif>)</a> | </cfif>
	...
	<cfif isUserInRole("admin")>| <a href="javaScript:launchBlogEditor(true, '#id#')">#application.resourceBundle.getResource("edit")#</a></cfif>
		</div>
