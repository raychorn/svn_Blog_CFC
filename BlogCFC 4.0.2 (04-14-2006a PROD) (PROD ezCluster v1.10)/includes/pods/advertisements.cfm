...
<cfmodule template="../../tags/podlayout.cfm" containerClass="rightMenuWide" title="#application.resourceBundle.getResource("advertisement")#">
	...
	<cfoutput>
		<table width="100%" cellpadding="-1" cellspacing="-1">
			<tr>
				...
				<td align="center" valign="top">
					<table width="100%" height="600" cellpadding="-1" cellspacing="-1">
						<tr>
