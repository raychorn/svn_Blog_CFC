...
<cfoutput>
	...
	<cfif application.localeutils.isBIDI()>
		<a href="index.cfm?mode=month&month=#month(nextMonth)#&year=#year(nextMonth)#" rel="nofollow">&lt;&lt;</a>
		<a href="index.cfm?mode=month&month=#month#&year=#year#" rel="nofollow">#localizedMonth# #localizedYear#</a>
		<a href="index.cfm?mode=month&month=#month(lastMonth)#&year=#year(lastMonth)#" rel="nofollow">&gt;&gt;</a>		
	<cfelse>
		<a href="index.cfm?mode=month&month=#month(lastMonth)#&year=#year(lastMonth)#" rel="nofollow">&lt;&lt;</a>
		<a href="index.cfm?mode=month&month=#month#&year=#year#" rel="nofollow">#localizedMonth# #localizedYear#</a>
		<a href="index.cfm?mode=month&month=#month(nextMonth)#&year=#year(nextMonth)#" rel="nofollow">&gt;&gt;</a>
...
<cfloop index="x" from="#dayCounter#" to="#dim#">
	...
	<cfoutput>
		...
		<cfif listFind(dayList,x)><a href="index.cfm?mode=day&day=#x#&month=#month#&year=#year#" rel="nofollow">#x#</a><cfelse>#x#</cfif>
		</td>
	</cfoutput>
