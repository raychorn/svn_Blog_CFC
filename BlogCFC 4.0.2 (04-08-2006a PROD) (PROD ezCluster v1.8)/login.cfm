...
<cfif (session.loginFailure lte 3)>
	<cfsavecontent variable="loginForm">
		...
		<div class="body">
		<cfset _URL = Request.commonCode._URLSessionFormat("http://#CGI.SERVER_NAME##ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), '_index.cfm', '/')#", false)>
