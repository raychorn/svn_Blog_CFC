			...
			<table width="100%" cellpadding="-1" cellspacing="-1">
				<tr>
					<td width="45%" align="left" valign="top">
						...
						<cfif 0>
							<cfset _http = Request.commonCode.cf_http(_url, true, true)>
							<cfset bool_isURL_valid = (Trim(_http.Statuscode) IS "200 OK")>
							<cfdump var="#_http#" label="_http [bool_isURL_valid=#bool_isURL_valid#]" expand="No">
						</cfif>
								...
								<td width="30%" align="center" valign="top">
									<cfif (FindNoCase("/login.cfm", CGI.SCRIPT_NAME) eq 0) AND (FindNoCase("/register.cfm", CGI.SCRIPT_NAME) eq 0)>
										...
										<cfelse>
											...
											<span class="normalPrompt"><NOBR>Welcome back <u>#_usersFullName#</u></NOBR><br><NOBR>Click <a href="#Request.commonCode.makeLinkToSelf('', true)#&logout=youbet">Here</a> if you are not <u>#_usersFullName#</u></NOBR><br><NOBR><a href="#Request.commonCode.makeLinkToSelf('', true)#&logout=youbet">Click Here to Logout</a></NOBR></span>
										</cfif>
									<cfelse>
										&nbsp;
									</cfif>
