...
<cftry>
	<cfscript>
		try {
			...
			writeOutput(Request.commonCode.cf_dump(e, 'CF Error', false));
		}
	</cfscript>
...
<cfmodule template="tags/layout.cfm">
	...
	<cfelseif url.mode is "cat">
		...
		<cfoutput>
		#application.resourceBundle.getResource("viewingbycategory")# : #cat# / <a href="#Request.commonCode._clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>	
	<cfelseif url.mode is "search">
		<cfoutput>
		#application.resourceBundle.getResource("searchedfor")# : #htmlEditFormat(form.search)# / <a href="#Request.commonCode._clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>
	<cfelseif url.mode is "entry">
		<cfoutput>
		#application.resourceBundle.getResource("viewingbyentry")# / <a href="#Request.commonCode._clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME##CGI.SCRIPT_NAME#')#">#application.resourceBundle.getResource("main")#</a>
		</cfoutput>
	</cfif>
	...
	<cfoutput query="articles" startrow="#url.startrow#" maxrows="#maxEntries#">
		...
		<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & '/' & ListFirst(CGI.SCRIPT_NAME, '/') & '/print.cfm') & "&id=#id#">
		<cfif application.isColdFusionMX7 AND (session.loggedin)><a href="#_url#" target="_blank" <cfif isDebugMode()>title="_url = [#_url#]"</cfif>>#application.resourceBundle.getResource("print")#</a><cfelse>#application.resourceBundle.getResource("print")#</cfif> | 
	...
	<cfelseif articles.recordCount gt url.startRow + maxEntries>
		...
		<cfoutput>
		<p align="right">
		<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & '/' & ListFirst(CGI.SCRIPT_NAME, '/') & '/_index.cfm') & qs>
