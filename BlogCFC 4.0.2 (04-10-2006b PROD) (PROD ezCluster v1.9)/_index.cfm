...
<cfmodule template="tags/layout.cfm">
	...
	<cfif (session.persistData.loggedin) AND (Request.commonCode.isUserAdmin())>| <a href="" onclick="launchBlogEditor(true, '#id#'); return false;">#application.resourceBundle.getResource("edit")#</a></cfif>
		</div>
