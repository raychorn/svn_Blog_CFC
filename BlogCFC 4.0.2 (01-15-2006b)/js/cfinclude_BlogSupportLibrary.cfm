<cfoutput>
	...
	function launchComment(id, bool_showHide) {
		...
		if ( (!!cObj) && (!!iObj) ) {
			...
			if (bool_showHide == true) iObj.src = '#application.rooturl#/addcomment.cfm?id=' + id + '&uuid=' + uuid();
		}
	}
	...
	function launchTrackback(id, bool_showHide) {
		...
		if ( (!!cObj) && (!!iObj) ) {
			cObj.style.display = ((bool_showHide == true) ? const_inline_style : const_none_style);
			if (bool_showHide == true) iObj.src = '#application.rooturl#/trackbacks.cfm?id=' + id + '&uuid=' + uuid();
		}
	}
	...
	<cfif isUserInRole("admin")>
		...
		function launchBlogEditor(bool_showHide, id) {
			...
			if ( (!!cObj) && (!!iObj) ) {
				cObj.style.display = ((bool_showHide == true) ? const_inline_style : const_none_style);
				if (bool_showHide == true) iObj.src = '#application.rooturl#/editor.cfm?id=' + ((id.toUpperCase() != 'NEW') ? id : 'new') + '&uuid=' + uuid();
			}
		}
		...
		function launchCategoryEditor(bool_showHide) {
			...
			if ( (!!cObj) && (!!iObj) ) {
				cObj.style.display = ((bool_showHide == true) ? const_inline_style : const_none_style);
				if (bool_showHide == true) iObj.src = '#application.rooturl#/category_editor.cfm' + '?uuid=' + uuid();
			}
		}
	...
	function expandBlogBody(id, divNamePrefix, btnNamePrefix) {
		var cObj = getGUIObjectInstanceById(divNamePrefix + id);
		var bObj = getGUIObjectInstanceById(btnNamePrefix + id);
		if ( (!!cObj) && (!!bObj) ) {
