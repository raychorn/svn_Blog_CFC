...
<cfmodule template="tags/layout.cfm">
	...
	<cfoutput query="articles" startrow="#url.startrow#" maxrows="#maxEntries#">
		...
		<h1><a name="#id#" href="#application.blog.makeLink(id)#">#title#</a></h1>
		...
		<cfif (displayStyle IS "none")>
			<table width="600" border="0" cellpadding="-1" cellspacing="-1">
				<tr>
					<td align="left" valign="top" width="120" style="margin-right: 20px;">
					...
					<td align="left" valign="top" width="*" style="margin-left: 20px;">
						#_html_#
					</td>
				</tr>
			</table>
		...
		<div class="byline">
		<cfif allowcomments><a href="" onclick="launchComment('#id#', true); return false;">#application.resourceBundle.getResource("comments")# (<cfif commentCount is "">0<cfelse>#commentCount#</cfif>)</a> | </cfif> 
		<cfif allowTB><a href="" onclick="launchTrackback('#id#', true); return false;">Trackbacks (<cfif trackbackCount is "">0<cfelse>#trackbackCount#</cfif>)</a> | </cfif>
	...
	<cfif isUserInRole("admin")>| <a href="" onclick="launchBlogEditor(true, '#id#'); return false;">#application.resourceBundle.getResource("edit")#</a></cfif>
		</div>
		...
		<cfif allowcomments>
			<div id="div_addComments_#id#" style="display: none;">
				<table width="580" border="1" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td>
							<iframe id="iframe_addComments_#id#" width="580" height="500" frameborder="1"></iframe>
						</td>
					</tr>
				</table>
			</div>
		...
		<cfif allowTB>
			<div id="div_addTrackback_#id#" style="display: none;">
				<table width="580" border="1" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td>
							<iframe id="iframe_addTrackback_#id#" width="580" height="500" frameborder="1"></iframe>
						</td>
					</tr>
				</table>
			</div>
		...
		<cfif isUserInRole("admin")>
			<div id="div_blog_editor_#id#" style="display: none;">
				<table width="600" border="1" cellpadding="-1" cellspacing="-1">
					...
					<tr>
						<td>
							<iframe id="iframe_blog_editor_#id#" width="600" height="650" frameborder="1"></iframe>
						</td>
					</tr>
				</table>
			</div>
