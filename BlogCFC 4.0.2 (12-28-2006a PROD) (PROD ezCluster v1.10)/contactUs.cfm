...
<cfdump var="#Session#" label="Session Scope [The Visitor's Identity]" expand="Yes">
	...
	<cfscript>
		...
		statusMsg = statusMsg & '<br><br><a href="#Request.commonCode.dropURLScopeFromURL(Request.commonCode.makeLinkToSelf('original_index.cfm', false))#">Click HERE to continue...</a>';
	</cfscript>
</cfif>
