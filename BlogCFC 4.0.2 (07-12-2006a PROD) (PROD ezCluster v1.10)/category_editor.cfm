...
<cfmodule template="tags/layout.cfm" title="#application.resourceBundle.getResource("categoryeditor")#" suppressLayout="true" maxWidth="350">
	...
	<table border="1">
		<tr>
			<td width="80%"><b>#application.resourceBundle.getResource("category")#</b></td>
		...
		<tr>
			<td>#categoryname#</td>
			<td>#entrycount#</td>
			<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), 'original_index.cfm', '/')) & '&edit=#categoryid#'>
			<td><nobr><a href="#_url#" <cfif isDebugMode()>title="_url = [#_url#]"</cfif>>#application.resourceBundle.getResource("edit")#</a> - 
			<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), 'original_index.cfm', '/')) & '&delete=#categoryid#'>
			<a href="#_url#" <cfif isDebugMode()>title="_url = [#_url#]"</cfif>>#application.resourceBundle.getResource("delete")#</a> - 
			<cfset _url = Request.commonCode._clusterizeURLForSessionOnly(Request.commonCode.clusterizeURL('http://#CGI.SERVER_NAME#') & ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), 'original_index.cfm', '/')) & '&mode=cat&catid=#categoryid#'>
			<a href="#_url#" <cfif isDebugMode()>title="_url = [#_url#]"</cfif>>#application.resourceBundle.getResource("view")#</a></nobr></td>
		</tr>
		</cfloop>
	</table>
	<p>
	<cfset _url = Request.commonCode._clusterizeURLForSessionOnly('http://#CGI.SERVER_NAME#' & ListSetAt(CGI.SCRIPT_NAME, ListLen(CGI.SCRIPT_NAME, '/'), 'original_index.cfm', '/'))>
