...
<cfif isDefined("form.delete")>
	...
	<cfoutput><script>window.opener.location.reload();window.close();</script></cfoutput>
	<cfabort>
</cfif>
...
<table width="100%" border=0>
	...
	<tr>
		...
		<input type="submit" name="cancel" value="#application.resourceBundle.getResource("cancel")#" onClick="window.close()"></td>
	</tr>
</table>
</form>
</cfoutput>
