...
<tr>
	<td>&nbsp;</td>
	<td><input type="reset" value="#application.resourceBundle.getResource("cancel")#" onClick="window.close()"> <input type="submit" name="addcomment" value="#application.resourceBundle.getResource("post")#"></td>
</tr>
</table>
