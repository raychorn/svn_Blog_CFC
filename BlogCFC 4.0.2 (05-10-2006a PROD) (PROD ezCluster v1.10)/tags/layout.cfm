...
<head>
	...
	<cfsavecontent variable="_jscode">
		<cfoutput>
			...
			#Request.commonCode.readAndObfuscateJSCode('js/events.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/CrossBrowserLibrary.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/CrossBrowserLibrary2.js')#
		</cfoutput>
	</cfsavecontent>
	...
	<cfsavecontent variable="_jscode">
		<cfoutput>
			#Request.commonCode.readAndObfuscateJSCode('js/AnchorPosition.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/support.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/BlogSupportLibrary.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/BlogSupportLibraryAdmin.js')#
			#Request.commonCode.readAndObfuscateJSCode('js/snapins.js')#
		</cfoutput>
	</cfsavecontent>
