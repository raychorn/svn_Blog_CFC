						...
						<table width="100%" cellpadding="-1" cellspacing="-1">
								...
								<td align="left" valign="top">
									<cfif (FindNoCase("/login.cfm", CGI.SCRIPT_NAME) eq 0) AND (FindNoCase("/register.cfm", CGI.SCRIPT_NAME) eq 0)>
										...
										<cfelse>
											...
											<span class="normalPrompt">Welcome back <u>#_usersFullName#</u><br>Click <a href="#Request.commonCode.makeLinkToSelf('', true)#&logout=youbet">Here</a> if you are not <u>#_usersFullName#</u></span>
										</cfif>
									<cfelse>
										&nbsp;
									</cfif>
							...
							<tr>
								<td colspan="3" align="left" valign="top">
									<span class="normalPrompt">Registered Users get <u>unlimited</u> access to Downloads, Blog Articles, Comments and Trackbacks as well as other soon to be announced Features.  There is No Cost to Get Registered.</span>
								</td>
							</tr>
						</table>
					</td>
